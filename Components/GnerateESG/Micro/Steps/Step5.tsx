...
const Step5 = ({ title, nextstep, prevstep }: Props) => {
  ...
  const [step5Data, setStep5Data] = useState({
    ...
    cybersecurityBreaches: {
      label: "Have there been any breaches in cyber security in the last three years?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    gdprCompliance: {
      label: "Is your company General Data Protection Regulation (GDPR) compliant?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    cyberAttackInsurance: {
      label: "What kind of insurance does the company have in place to protect it from cyber attacks?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    cyberAttackMitigation: {
      label: "What steps has the company taken to mitigate the risk of a cyber attack, such as penetration testing and employee training?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    itBestPractices: {
      label: "How does the company ensure that its IT systems comply with industry best practices?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    expectedCyberThreats: {
      label: "What kind of cyber security threats does the company expect to face in the coming year?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    ransomwareImpactHistory: {
      label: "Has the company been affected by any ransomware attacks in the past?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    cyberAttackRecoveryPlan: {
      label: "What kind of backup and recovery plan does the company have in place in the event of a cyber attack?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    itEnvironmentalSustainability: {
      label: "How does your IT strategy align with your organization's environmental sustainability goals?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    itCarbonFootprintReduction: {
      label: "What measures are in place to reduce the carbon footprint of your IT infrastructure (e.g., energy-efficient data centers, cloud computing)?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    itEmployeeWellbeingSupport: {
      label: "How does your IT policy support the well-being of your employees (e.g., ergonomics, digital wellness programs)?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    digitalWorkplaceSafety: {
      label: "Are there measures in place to prevent issues like digital overwork or cyber harassment?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    itGovernanceCompliance: {
      label: "How is governance maintained in IT and cybersecurity to ensure compliance with ESG standards?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    itCorporateGovernanceRole: {
      label: "What role does the IT department play in upholding corporate governance and ethical standards?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    itVendorEsgCompliance: {
      label: "How do you ensure that your IT vendors and partners comply with your ESG standards?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    esgProgressReports: {
      label: "Are there regular reports or assessments that demonstrate progress towards ESG objectives in IT and security management?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
    ...
    itEquipmentDisposalPolicy: {
      label: "Is there a policy in place for disposing of old or unused IT equipment?",
      value: "",
      type: "text",
      required: false,
      isAutoFill: true,
          ...
          Object.keys(step5Data).map((key, index) => {
            if (step5Data[key as keyof typeof step5Data].type === 'file') {
              return <UploadInput
                ...
                spaced={true}
                // @ts-ignore
                urls={step5Data[key as keyof typeof step5Data].url ? [step5Data[key as keyof typeof step5Data].url] : []}
            ...
            return (
              <Input
                ...
                setValue={(e: any) => setStep5Data({ ...step5Data, [key]: { ...step5Data[key as keyof typeof step5Data], value: e.target.value } })}
