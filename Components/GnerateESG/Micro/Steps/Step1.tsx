...
const Step1 = ({ title, nextstep }: Props) => {
  ...
  return (
    <StepsContainer
      title={`${selectedGlobalStandards.name} (${selectedGlobalStandards.short})`}
    >
      <form className="w-full h-full">
        <UploadInput
          urls={
            step1Data.picture.url !== "" ? [step1Data.picture.url] : undefined
          }
          spaced={true}
        ...
        <UploadInput
          urls={
            step1Data.customizedImages.url !== ""
              ? [step1Data.customizedImages.url]
              : undefined
          }
          spaced={true}
        ...
        <Input
          ...
          setValue={(e: any) =>
            setStep1Data({
              ...step1Data,
              companyName: { ...step1Data.companyName, value: e.target.value },
            })
          }
        ...
        <Input
          ...
          setValue={(e: any) =>
            setStep1Data({
              ...step1Data,
              yoi: { ...step1Data.yoi, value: e.target.value },
            })
          }
        ...
        <Input
          ...
          setValue={(e: any) =>
            setStep1Data({
              ...step1Data,
              email: { ...step1Data.email, value: e.target.value },
            })
          }
        ...
        <Input
          ...
          setValue={(e: any) =>
            setStep1Data({
              ...step1Data,
              telephone: { ...step1Data.telephone, value: e.target.value },
            })
          }
        ...
        <Input
          ...
          setValue={(e: any) =>
            setStep1Data({
              ...step1Data,
              website: { ...step1Data.website, value: e.target.value },
            })
          }
        ...
        <UploadInput
          ...
          setFiles={(files: any) =>
            setStep1Data({
              ...step1Data,
              logo: { ...step1Data.logo, value: files },
            })
          }
        />
        <UploadInput
          urls={
            step1Data.managementPicture.url !== ""
              ? [step1Data.managementPicture.url]
              : undefined
          }
          spaced={true}
        ...
        <div className="mt-[40px]">
          <Label checked={step1Data.reportingYear.value}>
            {step1Data.reportingYear.label}
          </Label>
          <div className="flex gap-[1rem] items-center">
            ...
            <Input
              ...
              readOnly={true}
              value={
                step1Data.reportingYear.value &&
                Number(step1Data.reportingYear.value) + 1
              }
              setValue={() => {}}
              type={"number"}
            />
        ...
        <div className="w-full p-6 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-md mt-[40px]">
          <Label checked={step1Data.dedicatedPerson.value}>
            {step1Data.dedicatedPerson.label}
          </Label>
          <div className="flex items-center gap-[1rem]">
            <Radio
              checked={step1Data.dedicatedPerson.value}
                  ...
                  setValue={(e: any) =>
                    setStep1Data({
                      ...
                      dedicatedPersonEmail: {
                        ...step1Data.dedicatedPersonEmail,
                        value: e.target.value,
                      },
                    })
                  }
          ...
          setValue={(e: any) =>
            setStep1Data({
              ...
              briefOnBusinessOperations: {
                ...step1Data.briefOnBusinessOperations,
                value: e.target.value,
              },
            })
          }
        ...
        <div className="w-full mt-[40px] p-6 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-md">
          <Label
            checked={
              Number(step1Data.numOfEmployees.value.male) +
                Number(step1Data.numOfEmployees.value.female) >
              0
            }
          >
            {step1Data.numOfEmployees.label}
          </Label>
              ...
              <Doughnut
                data={{
                  ...
                  datasets: [
                    {
                      data: [
                        step1Data.numOfEmployees.value.male || 50,
                        step1Data.numOfEmployees.value.female || 50,
                      ],
        ...
        <div className="w-full mt-[40px] p-6 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-md">
          <Label
            checked={
              Number(step1Data.diffAbledNumOfEmployees.value.male) +
                Number(step1Data.diffAbledNumOfEmployees.value.female) >
              0
            }
          >
            {step1Data.diffAbledNumOfEmployees.label}
          </Label>
          <div className="flex w-full mt-[30px] items-center gap-[2vw]">
            <Input
              transparent={true}
              ...
              <Doughnut
                data={{
                  ...
                  datasets: [
                    {
                      data: [
                        step1Data.diffAbledNumOfEmployees.value.male || 50,
                        step1Data.diffAbledNumOfEmployees.value.female || 50,
                      ],
                      backgroundColor: ["#00B8D9", "#FFA800"],
                      borderColor: ["#00B8D9", "#FFA800"],
                      borderWidth: 1,
          ...
          setValue={(e: any) =>
            setStep1Data({
              ...
              participationOfWomen: {
                ...step1Data.participationOfWomen,
                value: e.target.value,
              },
            })
          }
        ...
        <div className="w-full mt-[40px] p-6 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-md">
          <Label
            checked={
              Number(step1Data.numOfWorkers.value.fullTime) +
                Number(step1Data.numOfWorkers.value.partTime) +
                Number(step1Data.numOfWorkers.value.contract) >
              0
            }
          >
            {step1Data.numOfWorkers.label}
          </Label>
          <div className="flex w-full mt-[30px] items-center gap-[2vw]">
            <Input
              transparent={true}
                  ...
                  datasets: [
                    {
                      ...
                      data: [
                        Number(step1Data.numOfWorkers.value.fullTime) +
                          Number(step1Data.numOfWorkers.value.partTime) +
                          Number(step1Data.numOfWorkers.value.contract),
                        step1Data.numOfWorkers.value.fullTime,
                        step1Data.numOfWorkers.value.partTime,
                        step1Data.numOfWorkers.value.contract,
                      ],
                      backgroundColor: [
                        "#f3b344",
                        "#67e09c",
                      ...
                      borderColor: ["#f3b344", "#67e09c", "#3e8df3", "#49dd59"],
                      borderWidth: 1,
                    },
                  ],
                }}
          ...
          setValue={(e: any) =>
            setStep1Data({
              ...
              contratorParticipation: {
                ...step1Data.contratorParticipation,
                value: e.target.value,
              },
            })
          }
        ...
        <div className="w-full mt-[40px]">
          <Label checked={step1Data.bod.value}>{step1Data.bod.label}</Label>
          <div className="flex gap-[1rem] items-center">
            <Radio
              checked={step1Data.bod.value}
              name="bod"
              label="Yes"
              id="yes"
              onChange={() =>
            ...
            <>
              ...
              <div className="w-full flex gap-[2vw]">
                <Input
                  ...
                  name={"bodTotal"}
                  value={
                    Number(step1Data.maleBod.value) +
                    Number(step1Data.femaleBod.value)
                  }
                  setValue={() => {}}
                  disabled={true}
                  type={"number"}
                ...
                <Input
                  ...
                  setValue={(e: any) =>
                    setStep1Data({
                      ...step1Data,
                      maleBod: { ...step1Data.maleBod, value: e.target.value },
                    })
                  }
                  disabled={false}
        ...
        <div className="w-full mt-[40px]">
          ...
          <div className="flex gap-[1rem] items-center">
            <Radio
              checked={step1Data.publicTraded.value}
              name="publicTraded"
              label="Yes"
              id="yes"
              onChange={() =>
                setStep1Data({
                  ...step1Data,
                  publicTraded: { ...step1Data.publicTraded, value: true },
                })
              }
            />
            <Radio
              ...
              onChange={() =>
                setStep1Data({
                  ...step1Data,
                  publicTraded: { ...step1Data.publicTraded, value: false },
                })
              }
            />
          </div>
        ...
        <div className="w-full my-[40px]">
          ...
          <div className="flex gap-[1rem] items-center">
            <Radio
              checked={step1Data.boardComittee.value}
              name="boardComittee"
              label="Yes"
              id="yes"
              onChange={() =>
                setStep1Data({
                  ...step1Data,
                  boardComittee: { ...step1Data.boardComittee, value: true },
                })
              }
            />
            <Radio
              ...
              onChange={() =>
                setStep1Data({
                  ...step1Data,
                  boardComittee: { ...step1Data.boardComittee, value: false },
                })
              }
            />
          </div>
