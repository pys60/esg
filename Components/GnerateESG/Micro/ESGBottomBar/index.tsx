...
import { MdHomeFilled, MdOutlineNavigateBefore, MdOutlineNavigateNext } from "react-icons/md";
...
const ESGBottomBar = ({
  ...
  return (
    <div className='h-[10vh] z-10 bg-black w-full gap-[1rem] flex items-center justify-end px-[5%] fixed left-0 bottom-0' >
      <PriButton tooltip='Home' onClick={() => router.push('/')} className='!px-3 w-fit bg-white'>
        <MdHomeFilled className='h-[20px] w-[20px]' />
      </PriButton>
      <PriButton tooltip={
