  ...
  return (
    <>
      <div className='w-full relative justify-start min-h-[100vh] flex'>
        ...
        <div className={`${open ? 'w-[60vw]' : 'w-[100vw]'} transition-all duration-300 pb-[20vh] bg-[#e0faff] mt-[10vh] min-h-[100vh]`}>
          {children}
        </div>
        <div style={{
        ...
        }} className={`w-[40vw] transition-all duration-300 flex items-center justify-center fixed z-0 top-0 ${open ? 'right-0' : 'right-[-40vw]'} min-h-[100vh] `}>
